...
namespace ElaticSearch.WEB.Repositories
{
    public class ECommerceRepository
    {
        ...
        public async Task<(List<ECommerce> list, long totalCount)> SearchAsync(ECommerceSearchViewModel searchViewModel, int page, int pageSize) // Task bir tabıl nesnesine dönüşecek
        {
            ...
            {
                //Action<QueryDescriptor<ECommerce>> matchContent = (q) => q.Match(m => m.Field(f => f.Category).Query(searchViewModel.Category));
